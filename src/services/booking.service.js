...
const getBookingDetail = async (bookingCode, userId = null) => {
  ...
  return {
    ...
    outbound_flight: {
      ...
      airline:   { code: b.outbound_airline_code, name: b.outbound_airline_name, logo_url: b.outbound_airline_logo },
    ...
    return_flight: b.return_flight_id
      ? {
          ...
          airline:   { code: b.return_airline_code, name: b.return_airline_name, logo_url: b.return_airline_logo },
